<template>
  <div class="mt-6 rounded-3xl transition duration-300 p-6">
    ...
    <ul>
      <li class="flex flex-col px-8 py-3 items-center mt-3 bg-purple-50 rounded-lg" v-for="item of public_list" :key="item.id">
        <div class="w-full flex flex-row items-center ">
          ...
          <!--          User-->
          <div class="pl-6 h-32 w-32 flex flex-col justify-center items-center space-y-1">
